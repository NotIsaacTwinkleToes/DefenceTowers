...
public class TowerItems {
    ...
    private final ItemStack ammunition = StaticUtil.fastItem(Material.ARROW, ChatColor.WHITE + "Ammunition", new String[] {ChatColor.GRAY + "Ammunition: " + ChatColor.GOLD + "0", ChatColor.DARK_GRAY + "Shift + Click arrows in your inventory to put them in the turret"}, false);
